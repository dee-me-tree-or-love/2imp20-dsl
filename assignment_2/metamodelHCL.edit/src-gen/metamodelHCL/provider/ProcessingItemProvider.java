...
/**
 * This is the item provider adapter for a {@link metamodelHCL.Processing} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessingItemProvider extends ComponentItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ProcessingItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Processing"));
	}
	...
	public String getText(Object object) {
		String label = ((Processing) object).getLabel();
		return label == null || label.length() == 0 ? getString("_UI_Processing_type")
				: getString("_UI_Processing_type") + " " + label;
	}
